...
// ManufactureDate applies equality check predicate on the "manufacture_date" field. It's identical to ManufactureDateEQ.
func ManufactureDate(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldManufactureDate), v))
	})
}

// Cost applies equality check predicate on the "cost" field. It's identical to CostEQ.
func Cost(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
...
// ManufactureDateEQ applies the EQ predicate on the "manufacture_date" field.
func ManufactureDateEQ(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldManufactureDate), v))
	})
}

// ManufactureDateNEQ applies the NEQ predicate on the "manufacture_date" field.
func ManufactureDateNEQ(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldManufactureDate), v))
	})
}

// ManufactureDateIn applies the In predicate on the "manufacture_date" field.
func ManufactureDateIn(vs ...time.Time) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Car(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldManufactureDate), v...))
	})
}

// ManufactureDateNotIn applies the NotIn predicate on the "manufacture_date" field.
func ManufactureDateNotIn(vs ...time.Time) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Car(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldManufactureDate), v...))
	})
}

// ManufactureDateGT applies the GT predicate on the "manufacture_date" field.
func ManufactureDateGT(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldManufactureDate), v))
	})
}

// ManufactureDateGTE applies the GTE predicate on the "manufacture_date" field.
func ManufactureDateGTE(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldManufactureDate), v))
	})
}

// ManufactureDateLT applies the LT predicate on the "manufacture_date" field.
func ManufactureDateLT(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldManufactureDate), v))
	})
}

// ManufactureDateLTE applies the LTE predicate on the "manufacture_date" field.
func ManufactureDateLTE(v time.Time) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldManufactureDate), v))
	})
}

// CostEQ applies the EQ predicate on the "cost" field.
func CostEQ(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCost), v))
	})
}
...
func CostNEQ(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
...
func CostIn(vs ...float64) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CostNotIn(vs ...float64) predicate.Car {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CostGT(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
...
func CostGTE(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
...
func CostLT(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {
...
func CostLTE(v float64) predicate.Car {
	return predicate.Car(func(s *sql.Selector) {

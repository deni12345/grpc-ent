...
func (cu *CarUpdate) SetManufactureDate(t time.Time) *CarUpdate {
	cu.mutation.SetManufactureDate(t)
	return cu
}

// SetCost sets the "cost" field.
func (cu *CarUpdate) SetCost(f float64) *CarUpdate {
	cu.mutation.ResetCost()
	cu.mutation.SetCost(f)
	return cu
}

// AddCost adds f to the "cost" field.
func (cu *CarUpdate) AddCost(f float64) *CarUpdate {
	cu.mutation.AddCost(f)
	return cu
}
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.ManufactureDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: car.FieldManufactureDate,
		})
	}
	if value, ok := cu.mutation.Cost(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: car.FieldCost,
		})
	}
	if value, ok := cu.mutation.AddedCost(); ok {
...
// SetManufactureDate sets the "manufacture_date" field.
func (cuo *CarUpdateOne) SetManufactureDate(t time.Time) *CarUpdateOne {
	cuo.mutation.SetManufactureDate(t)
	return cuo
}

// SetCost sets the "cost" field.
func (cuo *CarUpdateOne) SetCost(f float64) *CarUpdateOne {
	cuo.mutation.ResetCost()
	cuo.mutation.SetCost(f)
	return cuo
}

// AddCost adds f to the "cost" field.
func (cuo *CarUpdateOne) AddCost(f float64) *CarUpdateOne {
	cuo.mutation.AddCost(f)
	return cuo
}
...
func (cuo *CarUpdateOne) sqlSave(ctx context.Context) (_node *Car, err error) {
	...
	if value, ok := cuo.mutation.ManufactureDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: car.FieldManufactureDate,
	...
	if value, ok := cuo.mutation.AddedCost(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: car.FieldCost,
